    ...
    public Coureur readCoureur(int idCoureur) {
        ...
        try(PreparedStatement pstm = dbConnect.prepareStatement(query)) {
            ...
            if(rs.next()){
                ...
                String nationnalite = rs.getString(6);
                int villeId = rs.getInt(7);

                Ville villeResidence = readVille(villeId);

                return new Coureur(idCoureur,matricule,nom,prenom,dateNaiss,nationnalite,villeResidence);
            }
            else return null;
        } catch (SQLException e) {
            System.out.println("erreur sql :"+e);
    ...
    public List<Coureur> getCoureurs() {
        ...
        try(Statement stm = dbConnect.createStatement()) {
            ...
            while(rs.next()){
                ...
                VilleDAO villeDAO = new VilleDAO(dbConnect);
                Ville villeResidence = villeDAO.readVille(villeId);
